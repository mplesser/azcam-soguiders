...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 1
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 2
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 3
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 4
...
214       X:000018                     DC      (DZ-0170)           ; OFFSET_R (5mV/DN) (-0170)
215       X:000019                     DC      (DZ-0170)           ; OFFSET_L      (-0170)
216       X:00001A                     DC      (DZ+0000)           ; B7        N/U


Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 5



217       X:00001B                     DC      (DZ-0200)           ; OG  voltage
218       X:00001C                     DC      (DZ+0000)           ; B5 (10 mV/DN) N/U
219       X:00001D                     DC      (DZ+1600)           ; RD    (+13v)
220       X:00001E                     DC      (DZ+2500)           ; OD_R  (+22v)
221       X:00001F                     DC      (DZ+2500)           ; OD_L
222    
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 6
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 7
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 8
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 9
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 10
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 11
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 12
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 13
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 14
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 15
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 16
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 17
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 18
...
Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 19
...
887       P:0002FC 64F400              MOVE    #SIG_AB,R4              ; bias DAC registers
                   FFFF88
888       P:0002FE 000000              NOP
889       P:0002FF 000000              NOP
890       P:000300 4C6400              MOVE    X0,Y:(R4)               ;
891       P:000301 08F4BB              MOVEP   #WS,X:BCR               ; re-set wait states
                   073FE1
892    
893                        ;--------------------------------------------------------------------
894    
895       P:000303 07F409              MOVEP   #$20,X:TCPR1            ; set timer compare value
                   000020
896       P:000305 0BF080              JSR     M_TIMER                 ; wait for output to settle
                   00032F
897    
898       P:000307 08F4BB              MOVEP   #WS3,X:BCR              ; set wait states for ADC
                   077FE1
899       P:000309 07B080              MOVEP   X:TCLKS,Y:<<SEQREG      ; assert /CONVST
                   000044
900       P:00030B 0604A0              REP     #$4                     ;
901       P:00030C 000000              NOP                             ;
902       P:00030D 07B080              MOVEP   X:(TCLKS+1),Y:<<SEQREG  ; deassert /CONVST and wait
                   000045
903       P:00030F 0650A0              REP     #$50                    ;
904       P:000310 000000              NOP                             ;
905    
906       P:000311 044C22              MOVEP   Y:<<ADC_B,A1            ; read ADC2
907       P:000312 45F400              MOVE    #>$FFFF,X1              ; prepare 16-bit mask   - RAT
                   00FFFF
908       P:000314 200066              AND     X1,A1                   ; get all 16 bits
909       P:000315 012D00              BCLR    #$0,X:PDRD              ; turn off temp sensor
910       P:000316 0BCC4D              BCHG    #$D,A1                  ; 2complement to binary
911       P:000317 08F4BB              MOVEP   #WS,X:BCR               ; re-set wait states
                   073FE1


Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 20



912       P:000319 541100              MOVE    A1,X:TEMP               ;
913       P:00031A 00000C              RTS                             ;
914    
915       P:00031B 08F4BB  TEMP_SET    MOVEP   #WS5,X:BCR              ; add wait states
                   07BFE1
916       P:00031D 000000              NOP                             ;
917    
918                        ; -------------------------------------------------------------------
919                        ; test  - 23 oct 07 RAT
920                        ; restore OFFSET_R value during imaging
921    
922       P:00031E 331800              MOVE    #VBIAS,R3               ; bias voltages (OFFSET_R is first)
923       P:00031F 64F400              MOVE    #SIG_AB,R4              ; bias DAC registers
                   FFFF88
924       P:000321 000000              NOP
925       P:000322 44E300              MOVE    X:(R3),X0               ;
926       P:000323 4C6400              MOVE    X0,Y:(R4)               ;
927    
928                        ;--------------------------------------------------------------------
929    
930    
931       P:000324 07B08A              MOVEP   X:TEC,Y:<<TEC_REG       ; set TEC DAC
                   00001A
932       P:000326 08F4BB              MOVEP   #WS,X:BCR               ; re-set wait states
                   073FE1
933       P:000328 00000C              RTS
934    
935                        ;*****************************************************************************
936                        ;   MILLISECOND AND MICROSECOND TIMER MODULE
937                        ;*****************************************************************************
938       P:000329 010F20  U_TIMER     BSET    #$0,X:TCSR0             ; start timer
939       P:00032A 014F20              BTST    #$0,X:TCSR0             ; delay for flag update
940    
941       P:00032B 018F95              JCLR    #$15,X:TCSR0,*          ; wait for TCF flag
                   00032B
942       P:00032D 010F00              BCLR    #$0,X:TCSR0             ; stop timer, clear flag
943       P:00032E 00000C              RTS                             ; flags update during RTS
944    
945       P:00032F 010B20  M_TIMER     BSET    #$0,X:TCSR1             ; start timer
946       P:000330 014F20              BTST    #$0,X:TCSR0             ; delay for flag update
947    
948       P:000331 018B95              JCLR    #$15,X:TCSR1,*          ; wait for TCF flag
                   000331
949       P:000333 010B00              BCLR    #$0,X:TCSR1             ; stop timer, clear flag
950       P:000334 00000C              RTS                             ; flags update during RTS
951    
952                        ;*****************************************************************************
953                        ;   SIGNAL-PROCESSING GAIN MODULE
954                        ;*****************************************************************************
955       P:000335 0A12A0  SET_GAIN    JSET    #$0,X:GAIN,HI_GAIN      ;
                   000338
956       P:000337 012D01              BCLR    #$1,X:PDRD              ; set gain=0
957       P:000338 0A1280  HI_GAIN     JCLR    #$0,X:GAIN,END_GAIN     ;
                   00033B


Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 21



958       P:00033A 012D21              BSET    #$1,X:PDRD              ; set gain=1
959       P:00033B 00000C  END_GAIN    RTS                             ;
960    
961                        ;*****************************************************************************
962                        ;   SIGNAL-PROCESSING DUAL-SLOPE TIME MODULE
963                        ;*****************************************************************************
964       P:00033C 07F00D  SET_USEC    MOVEP   X:USEC,X:TCPR0          ; timer compare value
                   000013
965       P:00033E 00000C  END_USEC    RTS                             ;
966    
967                        ;*****************************************************************************
968                        ;   SELECT SERIAL CLOCK SEQUENCE (IE OUTPUT AMPLIFIER)
969                        ;*****************************************************************************
970       P:00033F 569400  SET_SCLKS   MOVE    X:OPCH,A                ; 0x1=right 0x2=left
971       P:000340 44F400  RIGHT_AMP   MOVE    #>$1,X0                 ; 0x3=both  0x4=all
                   000001
972       P:000342 200045              CMP     X0,A                    ;
973       P:000343 0AF0A2              JNE     LEFT_AMP                ;
                   00034D
974       P:000345 46F400              MOVE    #>SCLKS_R,Y0            ; serial clock sequences
                   000070
975       P:000347 47F400              MOVE    #>SCLKS_FLR,Y1          ; serial flush sequences
                   000080
976       P:000349 75F400              MOVE    #PIX+1,N5               ; pointer to start of data
                   000301
977       P:00034B 08F4AD              MOVEP   #>$0,X:DCO0             ; DMA counter
                   000000
978       P:00034D 44F400  LEFT_AMP    MOVE    #>$2,X0                 ;
                   000002
979       P:00034F 200045              CMP     X0,A                    ;
980       P:000350 0AF0A2              JNE     BOTH_AMP                ;
                   00035A
981       P:000352 46F400              MOVE    #>SCLKS_L,Y0            ;
                   000078
982       P:000354 47F400              MOVE    #>SCLKS_FLL,Y1          ;
                   000088
983       P:000356 75F400              MOVE    #PIX,N5                 ;
                   000300
984       P:000358 08F4AD              MOVEP   #>$0,X:DCO0             ;
                   000000
985       P:00035A 44F400  BOTH_AMP    MOVE    #>$3,X0                 ;
                   000003
986       P:00035C 200045              CMP     X0,A                    ;
987       P:00035D 0AF0A2              JNE     END_AMP                 ;
                   000367
988       P:00035F 46F400              MOVE    #>SCLKS_B,Y0            ;
                   000090
989       P:000361 47F400              MOVE    #>SCLKS_FLB,Y1          ;
                   000098
990       P:000363 75F400              MOVE    #PIX,N5                 ;
                   000300
991       P:000365 08F4AD              MOVEP   #>$1,X:DCO0             ;
                   000001
992       P:000367 463000  END_AMP     MOVE    Y0,X:SCLKS              ;


Motorola DSP56300 Assembler  Version 6.3.4   08-09-10  12:37:05  gcam_512ft.asm  Page 22



993       P:000368 473100              MOVE    Y1,X:SCLKS_FL           ;
994       P:000369 00000C              RTS                             ;
995    
996                        ;*****************************************************************************
997                        ;   CMD.ASM -- ROUTINE TO INTERPRET AN 8-BIT COMMAND + COMPLEMENT
998                        ;*****************************************************************************
999                        ; Each command word is sent as two bytes -- the LSB has the command
1000                       ; and the MSB has the complement.
1001   
1002      P:00036A 568000  CMD_FIX     MOVE    X:CMD,A                 ; extract cmd[7..0]
1003      P:00036B 0140C6              AND     #>$FF,A                 ; and put in X1
                   0000FF
1004      P:00036D 218500              MOVE    A1,X1                   ;
1005      P:00036E 568000              MOVE    X:CMD,A                 ; extract cmd[15..8]
1006      P:00036F 0C1ED0              LSR     #$8,A                   ; complement
1007      P:000370 57F417              NOT     A   #>$1,B              ; and put in A1
                   000001
1008      P:000372 0140C6              AND     #>$FF,A                 ;
                   0000FF
1009      P:000374 0C1E5D              ASL     X1,B,B                  ;
1010      P:000375 200065              CMP     X1,A                    ; compare X1 and A1
1011      P:000376 0AF0AA              JEQ     CMD_OK                  ;
                   00037A
1012      P:000378 20001B  CMD_NG      CLR     B                       ; cmd word no good
1013      P:000379 000000              NOP                             ;
1014      P:00037A 550000  CMD_OK      MOVE    B1,X:CMD                ; cmd word OK
1015      P:00037B 000000              NOP                             ;
1016      P:00037C 00000C  END_CMD     RTS                             ;
1017   
1018                                   END
