...
*azcam-soguiders* is an *azcam* extension for Steward Observatory guide cameras using the Tcl/Tk guider app.

## Installation

Download from github: https://github.com/mplesser/azcam-soguiders.git.
