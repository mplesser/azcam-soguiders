...
class BokTCS(Telescope):
    ...
    def initialize(self):
        ...
        if self.use_bokpop:
            db["headerorder"].remove("telescope")

        # telescope server interface
        self.Tserver = TelcomServerInterface(self.Name)
    ...
    def get_focus(self, focus_id=0):
        ...
        try:
            self.focus_position = float(focpos)
        except:
            self.focus_position = focpos

        return ["OK", self.focus_position]
...
class TelcomServerInterface(object):
    ...
    def __init__(self, Name):
        ...
        telname = Name.lower()
        if telname == "bok":
            # self.Host='bokpc3.as.arizona.edu'
            # self.Host='140.252.86.14'
            ...
            # self.Host='bokga.as.arizona.edu'
            self.Host = "140.252.86.123"
            self.Port = 5750
            self.Name = "bok"
            self.TELID = "BOK"
            self.Offset = 10
        elif telname == "big61":
            # self.Host='bigguider.as.arizona.edu'
            self.Host = "128.196.210.156"
            self.Port = 5750
            self.Name = "big61"
            self.TELID = "BIG61"
            self.Offset = 12
            ...
            azcam.utils.log("ERROR bad telescope name: %s" % Name)
