...
;*****************************************************************************
    ...
    TABS    4
;*****************************************************************************
;   Code modified for the CCID-37 22 August 2006 - R. Tucker
;*****************************************************************************
...
HOLD_S          EQU     $0005           ; S clock timing (was 5)
...
;*****************************************************************************
            ...
            DC      (DZ-0050)           ; OFFSET_L
            DC      (DZ+0010)           ; B7
            DC      (DZ-0400)           ; OG  voltage
            DC      (DZ+1000)           ; B5 (10 mV/DN)
            DC      (DZ+1000)           ; RD
            DC      (DZ+1800)           ; OD_R
            DC      (DZ+1800)           ; OD_L
...
;                    ||||||||||||||||||||
             ...
             ORG X:MPP              ; reset/hold state (no MPP mode for CCID-37)
            DC  %000001001000011011000011

            ORG X:IPCLKS            ; input clamp
            DC  %000001001000011011010011
            DC  %000001001000011011000011

            ORG X:TCLKS             ; read temp monitor
            DC  %000001001000011011000010
            DC  %000001001000011011000011
            ...
            DC  %000001001000011011010011
            DC  %000001011000011011010011
            DC  %000001010000011011000011
            DC  %000001010100011011000011
            DC  %000001000100011011000011
            DC  %000001001100011011000011
...
; test
            ...
            ORG X:PCLKS_FL          ; parallel flush P3-P2-P1-P3
            DC  %000001001000011011000011
            DC  %000011011000011111100011
            DC  %000010010000011111100011
            DC  %000010110100011111100011
            DC  %000000100100011111100011
            DC  %000001101100011011000011
...
; ....................................................................
            ...
            DC  %000001001000011011100011   ; RG ON  FRST ON
            DC  %000001001000011011000011   ; RG OFF
            DC  %000001001000011011000001   ; FRST OFF
            DC  %000001001000011011001001   ; FINT+ ON
            ...
            DC  %000001001000011011100011   ; FRST ON RG ON

            ORG X:SCLKS_R           ; serial shift (right) S1-S2-S3-S1
            DC  %000001001000011011000001
            DC  %000001001000010010000001
            DC  %000001001000110110000001
            DC  %000001001000100100000001
            DC  %000001001000101101000001
            DC  %000001001000001001000001

            ORG X:SCLKS_FLR         ; serial flush (right) S1-S2-S3-S1
            DC  %000001001000011011100011
            DC  %000001001000010010100011
            DC  %000001001000110110100011
            DC  %000001001000100100100011
            DC  %000001001000101101100011
            DC  %000001001000001001100011
            ...
            DC  %000001001000101011000001
            DC  %000001001000100010000001
            DC  %000001001000110110000001
            DC  %000001001000010100000001
            DC  %000001001000011101000001
            DC  %000001001000001001000001

            ORG X:SCLKS_FLB         ; serial flush (both)
            DC  %000001001000101011100011
            DC  %000001001000100010100011
            DC  %000001001000110110100011
            DC  %000001001000010100100011
            DC  %000001001000011101100011
            DC  %000001001000001001100011

            ORG X:SCLKS_FF          ; serial flush (fast) DG
            DC  %000001001001011011100011
            DC  %000001001001000000100011
            DC  %000001001000000000100011
            DC  %000001001000011011100011
            DC  %000001001000011011100011   ; dummy code
            DC  %000001001000011011100011   ; dummy code
...
; set OFFSET_R to zero during idle periods.
            ...
            MOVE    #DZ-1000,X0             ; temperature bias voltage (OFFSET_R is first)
            MOVE    #SIG_AB,R4              ; bias DAC registers
		NOP					  ; -RAT 2 sep 08
		NOP					  ; -RAT 2 sep 08
            MOVE    X0,Y:(R4)               ;
