...
HOLD_ADC        EQU     $00FF           ; pre-sample settling (was F)
INIT_NROWS      EQU     $213            ; $200=(512)
INIT_NCOLS      EQU     $238            ; $204=(512)+4
INIT_NFT        EQU     $200            ; $200=512			
...
INIT_SCLKS      EQU     $2              ; 1=LEFT (TOP), 2=RIGHT (BOTTOM)
